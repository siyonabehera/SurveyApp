            ...
            <View style={styles.background}>
                <View style={styles.container}>
                    <ScrollView>
                        ...
                        <Text style={styles.questionText}>You said you are {answers.age} years old{answers.age > 1 ? '!' : '.'}</Text>
                        ...
                        <Text style={styles.questionText}>You chose: {answers.radio.value}</Text>
                        <Text style={styles.questionText}>Your dominant hand is your: {answers.singleDefault.value}</Text>
                        <Text style={styles.questionText}>You like to wear: {answers.multipleDefaults[0].value} and {answers.multipleDefaults[1].value}</Text>
